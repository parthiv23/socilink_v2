...
import styles from "./SociolinkChatPage.module.css";

const SociolinkChatPage: FunctionComponent = () => {
  ...
  return (
    <div className={styles.sociolinkChatPage}>
      <div className={styles.sociolinkChatPageChild} />
      <div className={styles.sociolinkChatPageItem} />
      ...
      <div className={styles.sociolinkChatPageInner} data-animate-on-scroll />
      <div className={styles.rectangleDiv} />
      <div className={styles.rectangleParent} data-animate-on-scroll>
        <div className={styles.frameInner} />
        <img className={styles.searchAltIcon} alt="" src="/searchalt3.svg" />
      ...
      <div className={styles.menuParent} data-animate-on-scroll>
        ...
        <img className={styles.frameChild1} alt="" src="/rectangle-11.svg" />
        <div className={styles.more}>More</div>
        <img className={styles.chatIcon} alt="" src="/chat3.svg" />
        ...
        <img className={styles.activityIcon} alt="" src="/activity3.svg" />
      ...
      >
        ...
        <img className={styles.frameChild7} alt="" src="/ellipse-5@2x.png" />
        ...
        <img className={styles.frameChild8} alt="" src="/ellipse-6@2x.png" />
        <img className={styles.frameChild9} alt="" src="/ellipse-9@2x.png" />
        <img className={styles.frameChild10} alt="" src="/ellipse-7@2x.png" />
        <img className={styles.frameChild11} alt="" src="/ellipse-10@2x.png" />
        <img className={styles.frameChild12} alt="" src="/ellipse-8@2x.png" />
        <img
      ...
      <div className={styles.rectangleGroup} data-animate-on-scroll>
        ...
        <img className={styles.frameChild18} alt="" src="/ellipse-33@2x.png" />
        <img className={styles.frameChild19} alt="" src="/ellipse-4@2x.png" />
        <img
      ...
      <div className={styles.rectangleContainer} data-animate-on-scroll>
        ...
        <img
          ...
          alt=""
          src="/bithreedotsvertical1.svg"
        />
        <img
          className={styles.ciphoneOutlineIcon}
          alt=""
          src="/ciphoneoutline1.svg"
        />
        <img
          className={styles.fluentvideo16RegularIcon}
          alt=""
          src="/fluentvideo16regular1.svg"
        />
...
export default SociolinkChatPage;
